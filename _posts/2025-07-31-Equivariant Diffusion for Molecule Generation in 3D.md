...
<figure>
  <img src="{{ site.baseurl }}/images/1.jpeg" alt="Molecule in 3D Space" width="640" height="320">
  <figcaption style="text-align: center;">Figure 1. Molecule in 3D Space</figcaption>
</figure>
...
<figure>
  <img src="{{ site.baseurl }}/images/3drole.png" alt="Role of Symmetry in 3D Space" width="640" height="320">
  <figcaption style="text-align: center;">Figure 2. Examples of reflection symmetry. (left) The ammonia molecule contains three identical reflection planes. All are designated as vertical symmetry planes ( σv ) because they contain the principle rotation axis.(middle) The water molecule contains two different reflection planes. (right) benzene contains a total of seven reflection planes, one horizontal plane ( σh) and six vertical planes ( σv
  and  σd ). Image created via Symmetry @ Otterbein site by Dean Johnston et al.</figcaption>
</figure>
...
<figure>
  <img src="{{ site.baseurl }}/images/gen-ai-diffusion-2560.jpeg" alt="Noising and Denoising Process on the Data" width="640" height="320">
  <figcaption style="text-align: center;">Figure  3. Noising and Denoising Process on the Data</figcaption>
</figure>
...
<figure>
  <img src="{{ site.baseurl }}/images/diffusion.png" alt="Overview of the Equivariant Diffusion Model. " width="640" height="320">
  <figcaption style="text-align: center;">Figure  4. Overview of the Equivariant Diffusion Model. </figcaption>
</figure>
...
<figure>
  <img src="{{ site.baseurl }}/images/result.png" alt="Selection of samples generated by the denoising process of our EDM trained on QM9 (up) and GEOM-DRUGS (down)" width="640" height="320">
  <figcaption style="text-align: center;">Figure  6. Selection of samples generated by the denoising process of our EDM trained on QM9 (up) and GEOM-DRUGS (down) </figcaption>
</figure>

<figure>
  <img src="{{ site.baseurl }}/images/geomdrugs.png" alt="Selection of sampling chains at different steps from a model trained on GEOM-Drugs. The final column shows the resulting sample from the model" width="640" height="400">
  <figcaption style="text-align: center;">Figure  7. Selection of sampling chains at different steps from a model trained on GEOM-Drugs. The final column shows the resulting sample from the model </figcaption>
</figure>
