...
<figure>
  ...
  <figcaption style="text-align: center;">Noising and Denoising Process on the Data</figcaption>
</figure>
...
<figure>
  ...
  <figcaption style="text-align: center;">Overview of the Equivariant Diffusion Model. </figcaption>
</figure>
...
<figure>
  ...
  <figcaption style="text-align: center;">Selection of samples generated by the denoising process of our EDM trained on QM9 (up) and GEOM-DRUGS (down) </figcaption>
</figure>
...
<figure>
  ...
  <figcaption style="text-align: center;">Selection of sampling chains at different steps from a model trained on GEOM-Drugs. The final column shows the resulting sample from the model </figcaption>
</figure>
